...
class Converter:
    ...
    def __init__(self):
        ...
        self.to_celsius_button.grid(row=0, padx=5, pady=5, column=0)
        ...
        self.to_fahrenheit_button.grid(row=0, padx=5, pady=5, column=1)
